...
/*
 * Callback from TTS androidEngineStruct.
 */
...
Java_com_svox_pico_SynthProxy_native_1setLowShelf(JNIEnv *env, jobject thiz, jboolean applyFilter,
...
JNIEXPORT jlong JNICALL
        Java_com_svox_pico_SynthProxy_nativeSetup(JNIEnv *env, jobject thiz,jstring engConfig)
{
    jlong result = 0;
    bUseFilter = false;
    ...
    android_tts_engine_t *engine = getTtsEngine();
...
Java_com_svox_pico_SynthProxy_native_1finalize(JNIEnv *env, jobject thiz, jlong jniData)
{
...
extern "C"
JNIEXPORT void JNICALL
Java_com_svox_pico_SynthProxy_native_1shutdown(JNIEnv *env, jobject thiz, jlong jniData)
{
Java_com_svox_pico_SynthProxy_native_1finalize(env, thiz, jniData);
}

extern "C"
JNIEXPORT jint JNICALL
        Java_com_svox_pico_SynthProxy_native_1isLanguageAvailable(JNIEnv *env, jobject thiz, jlong jniData,
...
extern "C"
JNIEXPORT jint JNICALL
        Java_com_svox_pico_SynthProxy_native_1setLanguage(JNIEnv *env, jobject thiz, jlong jniData,
                                              jstring language, jstring country, jstring variant)
{
    SynthProxyJniStorage* pSynthData = getSynthData(jniData);
    if (pSynthData == NULL) {
...
extern "C"
JNIEXPORT jint JNICALL
        Java_com_svox_pico_SynthProxy_native_1loadLanguage(JNIEnv *env, jobject thiz, jlong jniData,
                                               jstring language, jstring country, jstring variant)
{
    SynthProxyJniStorage* pSynthData = getSynthData(jniData);
    if (pSynthData == NULL) {
...
extern "C"
JNIEXPORT jint JNICALL
        Java_com_svox_pico_SynthProxy_native_1setProperty(JNIEnv *env, jobject thiz, jlong jniData,
...
extern "C"
JNIEXPORT jint JNICALL
        Java_com_svox_pico_SynthProxy_native_1speak(JNIEnv *env, jobject thiz, jlong jniData,
...
extern "C"
JNIEXPORT jint JNICALL
        Java_com_svox_pico_SynthProxy_native_1stop(JNIEnv *env, jobject thiz, jlong jniData)
{
    SynthProxyJniStorage* pSynthData = getSynthData(jniData);
    if (pSynthData == NULL) {
        return ANDROID_TTS_FAILURE;
...
extern "C"
JNIEXPORT jint JNICALL
        Java_com_svox_pico_SynthProxy_native_1stopSync(JNIEnv *env, jobject thiz, jlong jniData)
{
    SynthProxyJniStorage* pSynthData = getSynthData(jniData);
    if (pSynthData == NULL) {
        return ANDROID_TTS_FAILURE;
    ...
    int result = Java_com_svox_pico_SynthProxy_native_1stop(env, thiz, jniData);
    // but wait on the androidEngineStruct having released the androidEngineStruct mutex which protects
...
JNIEXPORT jobjectArray JNICALL
        Java_com_svox_pico_SynthProxy_native_1getLanguage(JNIEnv *env, jobject thiz, jlong jniData)
{
    SynthProxyJniStorage* pSynthData = getSynthData(jniData);
    if (pSynthData == NULL) {
        return NULL;
