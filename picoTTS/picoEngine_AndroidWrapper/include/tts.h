...
//
// This is passed by the framework to the androidEngineStruct through the
...
// Note that each of these functions will take a handle to the androidEngineStruct itself
